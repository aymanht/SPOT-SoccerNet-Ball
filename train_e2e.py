...
BASE_NUM_WORKERS = 0 if sys.platform == 'win32' else 4
...
def get_args():
    ...
    # Limit number of videos/matches for training
    parser.add_argument('--max_videos', type=int, default=None,
                        help='Maximum number of videos/matches to use for training (default: use all)')
...
def get_datasets(args):
    ...
    # Add max_videos limit if specified
    if args.max_videos is not None:
        dataset_kwargs['max_videos'] = args.max_videos
        print(f'Limiting training to {args.max_videos} videos/matches')
...
def main(args):
    ...
    train_loader = DataLoader(
        ...
        prefetch_factor=None, worker_init_fn=worker_init_fn)
