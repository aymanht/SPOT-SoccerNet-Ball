...
class ActionSpotDataset(Dataset):
    ...
    def __init__(
            ...
            max_videos=None,            # Maximum number of videos to use (for quick testing)
    ):
        ...
        if max_videos is not None and max_videos > 0:
            self._labels = self._labels[:max_videos]
            print(f'Limited to {len(self._labels)} videos from {label_file}')
